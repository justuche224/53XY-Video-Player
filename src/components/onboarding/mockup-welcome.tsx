// Purpose: delight — the one place in the app the wordmark is allowed to be
// the whole picture. `53` in the container's foreground, `XY` in the accent,
// the same split the Home header uses, so the mark is wallpaper-driven here
// too. Rises in once and rests.
...
/** The three things the tour is about to show, as a quiet strip under the mark. */
