...
## Status
- v1 + v2 shipped (Foundation, Library, Player, filters/sort, History, Resume, Playlists, bottom tab bar) and the **Visual Cohesion design-system overhaul (Phases 1–5)** is merged. See [HANDOFF.md](./HANDOFF.md) for current state + next candidates. 302 tests passing, tsc clean.
