...
| 3b-i | [../superpowers/plans/2026-06-18-player-gestures-i.md](../superpowers/plans/2026-06-18-player-gestures-i.md) | Discrete gestures: long-press→2× while held; 3-zone double-tap (left/center/right = back / play-pause / forward) + indicators. Pure JS. | ✅ Merged to master (75 tests, tsc clean, whole-branch review passed); device-verified (one deferred edge-tap issue) |
| 3b-ii-a | [../superpowers/plans/2026-06-18-player-gestures-ii-a.md](../superpowers/plans/2026-06-18-player-gestures-ii-a.md) | Pan gestures: swipe brightness (left, expo-brightness) / system volume (right, local Expo module `modules/system-volume`) / horizontal drag-scrub (preview+commit) + HUDs. | ✅ Merged to master (82 tests, tsc clean, whole-branch review passed); device-verified on SM-S901N |
| 3b-ii-b | [../superpowers/plans/2026-06-18-player-gestures-ii-b.md](../superpowers/plans/2026-06-18-player-gestures-ii-b.md) | Lock control (tap→reveal→tap unlock); edge-double-tap fix via gating double-tap to controls-hidden (proper RNGH-arena fix deferred — see spec). | ✅ Merged to master (82 tests, tsc clean, whole-branch review passed); device-verified — **completes v1** |
