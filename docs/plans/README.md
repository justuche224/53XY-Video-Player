...
| 3b-ii-b | `2026-06-XX-player-gestures-ii-b.md` (TBD) | Lock control (hide chrome + ignore gestures) + fix the edge-double-tap-while-controls-showing issue (compose chrome buttons into the gesture system). | Not written |
