...
_Last updated: after v2 **advanced filters** (length + name-pattern + folder ignore) and **library sort options** were built, reviewed, merged to `master`, and device-verified on the SM-S901N._
