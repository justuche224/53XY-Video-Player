...
- **Player replay fix:** Fixed a bug where a finished video couldn't be replayed without reopening it; pressing play at the end of a video now automatically seeks to 0 and replays. Added a dynamic replay icon (↻) when playback finishes.
